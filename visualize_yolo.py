...
# --- Configuration ---
IMAGE_PATH = "data/yolo/images/train/irs_pdfs_f1040_page_1.png" # Relative path to the image
LABEL_PATH = "data/yolo/labels/train/irs_pdfs_f1040_page_1.txt" # Relative path to the label file
